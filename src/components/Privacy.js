...
function Privacy() {
  return (
    <div style={contentStyle}>
      ...
      <p>
        When you register or use our tutoring services, we may ask for your contact information, including items such as name, email address, and class information.
      </p>
      ...
      <ul>
        ...
        <li>Communicate with you to provide assistance</li>
        <li>Prevent fraud and monitor for security</li>
        <li>With your consent, share research findings based on collected data. We will never distribute personally identifying information without consent.</li>
      </ul>
      ...
      <p>
        For more general information on cookies, please read the Cookies article on the TermsFeed website.
      </p>
      ...
      <p>
        You can disable cookies through your browser options. More detailed information about cookie management with specific web browsers can be found at the browsers' respective websites.
      </p>
      ...
      <ul>
        ...
        <li>Request that a business that sells consumer data not sell the consumer's personal data.</li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>The right to rectification – You have the right to request that we correct any information you believe is inaccurate or complete any incomplete information.</li>
        <li>The right to erasure – You have the right to request that we erase your personal data, under certain conditions.</li>
        <li>The right to restrict processing – You have the right to request that we restrict the processing of your personal data, under certain conditions.</li>
        <li>The right to object to processing – You have the right to object to our processing of your personal data, under certain conditions.</li>
        <li>The right to data portability – You have the right to request that we transfer your collected data to another organization, or directly to you, under certain conditions.</li>
      </ul>
      <p>
